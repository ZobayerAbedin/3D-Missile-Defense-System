...
public:
    ...
    float shininess;
    // ctor/dtor
    Sphere(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(0.3f, 0.25f, 0.2f), glm::vec3 diff = glm::vec3(1.0f, 0.95f, 0.82f), glm::vec3 spec = glm::vec3(1.0f, 1.0f, 1.0f), float shiny = 32.0f) : verticesStride(24)
    {
